...
//    this.shooterSubsystem = shooterSubsystem;
    ...
    addRequirements(/*shooterSubsystem*/eastShooter, limelight, towerSubsystem, driveSubsystem);
  }
...
//    );
  ...
  public void execute() {
    eastShooter.setShooterRPM(
            eastShooter.calculateBottomRPM(limelight.calculateDistance()),
            eastShooter.calculateTopRPM(limelight.calculateDistance())
    );
