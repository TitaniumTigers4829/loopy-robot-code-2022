...
public class EastShooter extends SubsystemBase {
  ...
  private LinearInterpolator bottomInterpolator;
  private LinearInterpolator topInterpolator;

  public EastShooter() {
    bottomInterpolator = new LinearInterpolator(ShooterConstants.bottomMotorValues);
    topInterpolator = new LinearInterpolator(ShooterConstants.topMotorValues);
...
//    bottomMotorRPM *= 0-9;
  ...
  public double calculateBottomRPM(double distance){
    return bottomInterpolator.getInterpolatedValue(distance);
  }

  public double calculateTopRPM(double distance){
    return topInterpolator.getInterpolatedValue(distance);
  }
